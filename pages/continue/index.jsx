        ...
        <div className='py-6'>
          <div className='flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl'>
            ...
            <div className='w-full p-8 lg:w-1/2'>
              ...
              <Link href='#'>
                <a className='flex items-center justify-center mt-4 hover:text-paper text-white transition duration-500 ease-in-out hover:bg-white rounded-2xl shadow-lg bg-paper'>
              ...
              <div className='mt-4'>
                <div className='flex justify-between'>
                  ...
                  <Link href='#'>
                    <a className='text-xs text-gray-500 hover:text-paper'>
                      Forget Password?
                    </a>
                  </Link>
                </div>
                ...
                <Switch
                  checked={toggle}
                  onChange={setToggle}
                  className='relative transition duration-500 ease-in-out flex items-center h-6 lg:left-80 left-64 rounded-full z-20 bottom-12 w-11 bg-paper '
                >
